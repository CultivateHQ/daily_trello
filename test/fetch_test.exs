...
defmodule FetchTest do
  ...
  test "good response" do
    assert handle_response(%{status_code: 200, body: " {\"_value\":\"A thing\"} "}) ==  {:ok, [{"_value", "A thing"}]}
  end


  test "error resonse" do
    assert handle_response(%{status_code: 500, body: "Something bad happened"}) ==  {:error, %{status_code: 500, body: "Something bad happened"}}
  end
